      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => {
              if (!canCreateContract()) { openUpgradeModal(); return }
              router.push('/dashboard/shartnomalar/ommaviy')
            }}
            className="flex items-center gap-2 bg-[#1F2937] hover:bg-[#111827] border border-[#1E293B] text-gray-300 hover:text-white px-4 py-2.5 rounded-lg text-sm font-medium transition"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
