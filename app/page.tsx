...
const LP: Record<Lang, {
  ...
  uz: {
    badge: "O'zbekistondagi birinchi professional shartnoma generatori",
    h1a: "Shartnomalarni", h1b: "tez", h1c: " va ", h1d: "professional", h1e: "yarating",
    subtitle: "Word'da vaqt sarflashni bas qiling. Rekvizitlarni bir marta kiriting — barcha shartnomalar avtomatik to'lsin. PDF tayyor.",
    cta: "Bepul boshlash", how: "Qanday ishlaydi?",
    freeNote: "Oyiga 5 ta shartnoma — bepul. Kredit karta kerak emas.",
    statsLabels: ["Shartnoma turi", "O'rtacha yaratish vaqti", "Ma'lumotlar xavfsizligi"],
    featuresTag: "IMKONIYATLAR", featuresTitle: "Nima uchun Shartnoma.uz?",
    featuresSub: "Word hujjatlaridan farqli — xatolarni kamaytiradi, vaqtingizni tejaydi",
    features: [
      { title: "Tezkor yaratish", desc: "8 tur shartnomadan birini tanlang, ma'lumotlar avtomatik to'ldiriladi. 5 daqiqada tayyor." },
      { title: "Ko'p tashkilot", desc: "Bitta hisobda bir nechta tashkilotni boshqaring. Buxgalterlar uchun ideal yechim." },
      { title: "Kontragentlar bazasi", desc: "STR yoki nom bo'yicha qidiring. Bir marta kiriting — har safar tayyor." },
      { title: "Professional PDF", desc: "A4 formatda toza, imzo va muhr bilan professional ko'rinishdagi PDF hujjat." },
      { title: "Nusxa olish", desc: "Avvalgi shartnomadan bir tugma bilan yangi nusxa yarating va o'zgartiring." },
      { title: "To'liq xavfsizlik", desc: "Har bir foydalanuvchi faqat o'z ma'lumotlarini ko'radi. Shifrlangan saqlash." },
    ],
    howTag: "QANDAY ISHLAYDI", howTitle: "3 qadam — shartnoma tayyor",
    steps: [
      { title: "Ro'yxatdan o'ting", desc: "Bepul hisob oching. Tashkilot rekvizitlarini bir marta kiriting." },
      { title: "Kontragent qo'shing", desc: "Kontragent ma'lumotlarini kiriting. Keyingisida STR bo'yicha tez topiladi." },
      { title: "Shartnoma yarating", desc: "Turni tanlang, raqam va summa kiriting — PDF bir daqiqada tayyor!" },
    ],
    ...
    popular: "🔥 Mashhur", comingSoon: "✨ Tez kutda",
    freeFeatures: ["Oyiga 5 ta shartnoma", "8 tur shartnoma", "PDF yuklab olish", "Kontragentlar bazasi", "Shartnoma.uz belgili PDF"],
    stdFeatures: ["Cheksiz shartnomalar", "8 tur shartnoma", "Reklama belgisisiz PDF", "Imzo va muhr avtomatik", "Nusxa olish funksiyasi", "Bir nechta bank hisob", "Ustunlik qo'llab-quvvatlash"],
    aiFeatures: ["Standart tarifning hammasi", "AI shartnoma tahlili", "Word fayldan shablon yaratish", "Yuridik xavf aniqlash", "Grammatika tekshiruvi", "Avtomatic matn to'ldirish", "Ustuvor qo'llab-quvvatlash"],
    startFree: "Bepul boshlash", start: "Boshlash →", signup: "Ro'yxatdan o'tish →",
    payNote: "To'lov: bank o'tkazma orqali. Aktivatsiya 24 soat ichida.",
    ...
    trust: [
      ...
      { title: "Shifrlangan saqlash", desc: "Barcha ma'lumotlar shifrlangan holda saqlanadi. Uchinchi shaxs kirа olmaydi." },
      { title: "Doim mavjud", desc: "99.9% uptime kafolati. Vercel va Supabase infratuzilmasi asosida." },
    ],
    ctaTitle: "Bugun boshlang",
    ctaSub: "Word hujjatlariga sarflangan vaqtni biznesni rivojlantirishga sarflang. Minglab tashkilotlar allaqachon tejash yo'lida.",
  ...
  oz: {
    badge: "Ўзбекистондаги биринчи профессионал шартнома генератори",
    h1a: "Шартномаларни", h1b: "тез", h1c: " ва ", h1d: "профессионал", h1e: "яратинг",
    subtitle: "Worddа вақт сарфлашни бас қилинг. Реквизитларни бир марта киритинг — барча шартномалар автоматик тўлсин. PDF тайёр.",
    cta: "Бепул бошлаш", how: "Қандай ишлайди?",
    freeNote: "Ойига 5 та шартнома — бепул. Кредит карта керак эмас.",
    statsLabels: ["Шартнома тури", "Ўртача яратиш вақти", "Маълумотлар хавфсизлиги"],
    featuresTag: "ИМКОНИЯТЛАР", featuresTitle: "Нима учун Shartnoma.uz?",
    featuresSub: "Word ҳужжатларидан фарқли — хатоларни камайтиради, вақтингизни тежайди",
    features: [
      { title: "Тезкор яратиш", desc: "8 тур шартномадан бирини танланг, маълумотлар автоматик тўлдирилади. 5 дақиқада тайёр." },
      { title: "Кўп ташкилот", desc: "Битта ҳисобда бир нечта ташкилотни бошқаринг. Бухгалтерлар учун идеал ечим." },
      { title: "Контрагентлар базаси", desc: "СТР ёки ном бўйича қидиринг. Бир марта киритинг — ҳар сафар тайёр." },
      { title: "Профессионал PDF", desc: "A4 форматда тоза, имзо ва муҳр билан профессионал кўринишдаги PDF ҳужжат." },
      { title: "Нусха олиш", desc: "Аввалги шартномадан бир тугма билан янги нусха яратинг ва ўзгартиринг." },
      { title: "Тўлиқ хавфсизлик", desc: "Ҳар бир фойдаланувчи фақат ўз маълумотларини кўради. Шифрланган сақлаш." },
    ],
    howTag: "ҚАНДАЙ ИШЛАЙДИ", howTitle: "3 қадам — шартнома тайёр",
    steps: [
      { title: "Рўйхатдан ўтинг", desc: "Бепул ҳисоб очинг. Ташкилот реквизитларини бир марта киритинг." },
      { title: "Контрагент қўшинг", desc: "Контрагент маълумотларини киритинг. Кейингисида СТР бўйича тез топилади." },
      { title: "Шартнома яратинг", desc: "Турни танланг, рақам ва сумма киритинг — PDF бир дақиқада тайёр!" },
    ],
    ...
    popular: "🔥 Машҳур", comingSoon: "✨ Тез кутда",
    freeFeatures: ["Ойига 5 та шартнома", "8 тур шартнома", "PDF юклаб олиш", "Контрагентлар базаси", "Shartnoma.uz белгили PDF"],
    stdFeatures: ["Чексиз шартномалар", "8 тур шартнома", "Реклама белгисисиз PDF", "Имзо ва муҳр автоматик", "Нусха олиш функцияси", "Бир нечта банк ҳисоб", "Устунлик қўллаб-қувватлаш"],
    aiFeatures: ["Стандарт тарифнинг ҳаммаси", "AI шартнома таҳлили", "Word файлдан шаблон яратиш", "Юридик хавф аниқлаш", "Грамматика текшируви", "Автоматик матн тўлдириш", "Устувор қўллаб-қувватлаш"],
    startFree: "Бепул бошлаш", start: "Бошлаш →", signup: "Рўйхатдан ўтиш →",
    payNote: "Тўлов: банк ўтказма орқали. Активация 24 соат ичида.",
    ...
    ctaSub: "Word ҳужжатларига сарфланган вақтни бизнесни ривожлантиришга сарфланг. Мингlab ташкилотлар аллақачон тежаш йўлида.",
  ...
  ru: {
    badge: "Первый профессиональный генератор договоров в Узбекистане",
    h1a: "Создавайте договоры", h1b: "быстро", h1c: " и ", h1d: "профессионально", h1e: "",
    subtitle: "Забудьте о Word. Введите реквизиты один раз — все договоры заполнятся автоматически. PDF готов.",
    cta: "Начать бесплатно", how: "Как это работает?",
    freeNote: "5 договоров в месяц — бесплатно. Карта не нужна.",
    statsLabels: ["Типов договоров", "Среднее время создания", "Безопасность данных"],
    featuresTag: "ВОЗМОЖНОСТИ", featuresTitle: "Почему Shartnoma.uz?",
    featuresSub: "В отличие от Word — сокращает ошибки и экономит ваше время",
    features: [
      { title: "Быстрое создание", desc: "Выберите один из 8 типов договоров, данные заполняются автоматически. Готово за 5 минут." },
      { title: "Несколько организаций", desc: "Управляйте несколькими организациями в одном аккаунте. Идеально для бухгалтеров." },
      { title: "База контрагентов", desc: "Поиск по ИНН или названию. Введите один раз — каждый раз готово." },
      { title: "Профессиональный PDF", desc: "Чистый документ формата A4 с подписью и печатью в профессиональном виде." },
      { title: "Копирование", desc: "Создайте новую копию из предыдущего договора одной кнопкой и измените." },
      { title: "Полная безопасность", desc: "Каждый пользователь видит только свои данные. Зашифрованное хранение." },
    ],
    howTag: "КАК ЭТО РАБОТАЕТ", howTitle: "3 шага — договор готов",
    steps: [
      { title: "Зарегистрируйтесь", desc: "Создайте бесплатный аккаунт. Введите реквизиты организации один раз." },
      { title: "Добавьте контрагента", desc: "Введите данные контрагента. В следующий раз быстро найдёте по ИНН." },
      { title: "Создайте договор", desc: "Выберите тип, введите номер и сумму — PDF готов за минуту!" },
    ],
    ...
    popular: "🔥 Популярный", comingSoon: "✨ Скоро",
    freeFeatures: ["5 договоров в месяц", "8 типов договоров", "Скачивание PDF", "База контрагентов", "PDF с маркой Shartnoma.uz"],
    stdFeatures: ["Неограниченные договоры", "8 типов договоров", "PDF без рекламы", "Автоматические подпись и печать", "Функция копирования", "Несколько банковских счетов", "Приоритетная поддержка"],
    aiFeatures: ["Всё из тарифа Стандарт", "AI-анализ договора", "Создание шаблона из Word-файла", "Выявление юридических рисков", "Проверка грамматики", "Автозаполнение текста", "Приоритетная поддержка"],
    startFree: "Начать бесплатно", start: "Начать →", signup: "Зарегистрироваться →",
    payNote: "Оплата: банковский перевод. Активация в течение 24 часов.",
    ...
    ctaSub: "Время, потраченное на Word-документы, направьте на развитие бизнеса. Тысячи организаций уже экономят.",
